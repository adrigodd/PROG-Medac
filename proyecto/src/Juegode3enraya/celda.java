...
/**
 * Esta clase sirve para poder modificar cada celda del tablero, es decir, un tablero es un arrays formado de celdas
...
/**
 * Constructor  vacío.
 * @param ocupado inicializamos en false porque al principio la celda no esta ocupada
 */
public celda() {
	this.ocupado=false;
}
