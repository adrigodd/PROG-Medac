...
public class Actividades3_3PrimeraPag extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Actividades3_3PrimeraPag frame = new Actividades3_3PrimeraPag();
	 ...
	 * Create the frame.
	 */
	public Actividades3_3PrimeraPag() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Actividades3_3SegundaPag a=new Actividades3_3SegundaPag();
				a.setVisible(true);
			}
		});
